...
while running:
    ...
    #공 rect 정보 업데이트
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                if ball_img_idx < 3:
                    ...
                    balls.append({
                        ...
                        "pos_y" : ball_pos_y + (ball_height/2) - (small_ball_height), #공의 y좌표
        ...
        break #안쪽 for문에서 break문을 만나면 여기로 진입 가능. 2중 for문을 한번에 탈출
    ...
    #경과 시간 계산 
    elapesed_time = (pygame.time.get_ticks()-start_ticks) / 1000 #ms -> s
    timer = game_font.render("Time : {}".format(int(total_time - elapesed_time)),True,(255,255,255))
